...
// Визуализация расписания, успеваемости и посещаемости студентов.
// ● Создание и редактирование учебных материалов и заданий.
// ● Ввод и изменение оценок за задания и контрольные работы.
// ● Просмотр и изменение информации о группе студентов.
// ● Работа с отчетами (по посещаемости, успеваемости и т.д.).
// ● Взаимодействие с другими пользователями системы (например,
